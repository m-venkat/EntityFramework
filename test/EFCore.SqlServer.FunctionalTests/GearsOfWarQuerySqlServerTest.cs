...
WHERE [f].[Discriminator] = N'LocustHorde'");
        ...
        public override void OfType_result_operator_overrides_Cast_that_comes_before()
        {
            base.OfType_result_operator_overrides_Cast_that_comes_before();
...
WHERE [f].[Discriminator] = N'LocustHorde'");
        ...
        public override void When_lifting_multiple_Cast_operators_last_one_wins()
        {
            base.When_lifting_multiple_Cast_operators_last_one_wins();
